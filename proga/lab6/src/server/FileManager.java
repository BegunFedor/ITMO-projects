...
public class FileManager {
    ...
    public FileManager(String defaultFile) {
        this.filePath = defaultFile;
        this.gson = new GsonBuilder()
                .setPrettyPrinting()
                .create(); // убрали адаптеры для LocalDateTime
    }

    public void save(LinkedHashMap<Integer, StudyGroup> collection) {
        save(collection, this.filePath);
    }
    ...
    public LinkedHashMap<Integer, StudyGroup> load() {
