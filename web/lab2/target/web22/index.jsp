...
<form method="POST" action="controller" id="mainForm">
  <table class="main-container">
    ...
    <input type="hidden" id="lastPointY" value="<%= request.getAttribute
("point") != null ? ((Point)request.getAttribute
("point")).getY() : "" %>">
    <input type="hidden" id="lastPointR" value="<%= request.getAttribute
("point") != null ? ((Point)request.getAttribute
("point")).getR() : "" %>">
    <input type="hidden" id="lastPointHit" value="<%= request.getAttribute
("point") != null ? ((Point)request.getAttribute
("point")).isHit() : "" %>">
    <tr>
      <td class="form-section">
        <table class="form-table">
          ...
          <tr>
            <td class="label-cell">
              <label for="y-input">Y координата:</label>
            </td>
        ...
        <div class="rtd">
          <table class="results-table">
            ...
            <%
              ...
              String tz = (String) request.getAttribute("timezone");
              if (points == null){
            %>
            <tr>
            ...
            <tr>
              ...
              <td><%= String.format("%.3f", p.getExecutionTime() / 1000000.0) %> </td>
              <td><%= p.getTimezone() != null ? p.getTimezone() : "—" %></td>
            </tr>
            <%
                }
              }
